<template>
  ...
  <el-main>
    ...
    <el-form ref="searchFromRef" :model="listPara" label-width="80px" :inline="true" size="small">
      ...
      <el-form-item v-if="$checkPermission(['sys:sysUserList:search','sys:sysUserList:reset','sys:sysUserList:add'])">
    ...
    <el-table :height="tableHeight" :data="tableData" border stripe>
      ...
      <el-table-column
        v-if="$checkPermission(['sys:sysUserList:edit','sys:sysUserList:delete'])"
        label="操作"
        align="center"
        width="180"
      >
